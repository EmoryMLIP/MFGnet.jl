...
using Revise
using MFGnet
include("../examples/viewers.jl")
include("../examples/runOMThelpers.jl")
...
@isdefined(nTh)         ? nTh=nTh           : nTh=4                   # number of nodes in ResNet discretization
